...
#define InsertObjectGT4 ((__int16 *(__cdecl*)(__int16 *ptrObj, int number, SORTTYPE sortType)) 0x00405F10)
#define InsertObjectGT3 ((__int16 *(__cdecl*)(__int16 *ptrObj, int number, SORTTYPE sortType)) 0x00406970)
...
#define InsertGT3_Sorted ((void (__cdecl*)(PHD_VBUF *vtx0, PHD_VBUF *vtx1, PHD_VBUF *vtx2, PHD_TEXTURE *texture, PHD_UV *uv0, PHD_UV *uv1, PHD_UV *uv2, SORTTYPE sortType)) 0x00409EC0)

void __cdecl InsertClippedPoly_Textured(int vtxCount, float z, __int16 polyType, __int16 texPage); // 0x0040A5D0

#define InsertGT4_Sorted ((void (__cdecl*)(PHD_VBUF *vtx0, PHD_VBUF *vtx1, PHD_VBUF *vtx2, PHD_VBUF *vtx3, PHD_TEXTURE *texture, SORTTYPE sortType)) 0x0040A780)
