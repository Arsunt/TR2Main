...
#define _Direct3D2					VAR_U_(0x004D7EB0, LPDIRECT3D2)
#define _Direct3DViewport2			VAR_U_(0x004D7EB4, LPDIRECT3DVIEWPORT2)
#define _Direct3DMaterial2			VAR_U_(0x004D7EB8, LPDIRECT3DMATERIAL2)
#define MinWindowClientHeight		VAR_U_(0x004D7EC0, int)
#define _DirectDraw					VAR_U_(0x004D7EC4, LPDIRECTDRAW)
#define IsGameWindowChanging		VAR_U_(0x004D7EC8, bool)
#define MaxWindowHeight				VAR_U_(0x004D7ECC, int)
#define _DirectDraw2				VAR_U_(0x004D7ED0, LPDIRECTDRAW2)
...
#define _DirectInput				VAR_U_(0x004D854C, LPDIRECTINPUT)
...
#define _DirectSound				VAR_U_(0x004D8D74, LPDIRECTSOUND)
...
#define RenderBufferSurface			VAR_U_(0x004D8EA0, LPDIRECTDRAWSURFACE3)
#define _DirectDrawClipper			VAR_U_(0x004D8EA4, LPDIRECTDRAWCLIPPER)
#define ThirdBufferSurface			VAR_U_(0x004D92A8, LPDIRECTDRAWSURFACE3)
#define PictureBufferSurface		VAR_U_(0x004D92AC, LPDIRECTDRAWSURFACE3)
#define ZBufferSurface				VAR_U_(0x004D92B0, LPDIRECTDRAWSURFACE3)
#define _DirectDrawPalette			VAR_U_(0x004D92B4, LPDIRECTDRAWPALETTE)
#define PrimaryBufferSurface		VAR_U_(0x004D92B8, LPDIRECTDRAWSURFACE3)
...
#define BackBufferSurface			VAR_U_(0x004D9348, LPDIRECTDRAWSURFACE3)
...
#define CurrentTexSource			VAR_U_(0x00519EC8, D3DTEXTUREHANDLE)
...
#define CD_LoopID					VAR_U_(0x0051BDA0, int)
...
#define TIME_Ticks					VAR_U_(0x0051C240, double)
#define TIME_Frequency				VAR_U_(0x0051C248, double)
#define TIME_Period_us				VAR_U_(0x0051C250, double)
#define TIME_Start_us				VAR_U_(0x0051C258, double)
#define TIME_Start					VAR_U_(0x0051C260, DWORD)
...
#define InvColours					VAR_U_(0x005216E0, INV_COLOURS)
#define SoundEffectCount			VAR_U_(0x00521FDC, DWORD)
...
#define GamePalette8				ARRAY_(0x0051B920, RGB, 256)
