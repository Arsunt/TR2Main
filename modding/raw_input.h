...
/*
 * This whole RawInput implementation is created for Sony DualShock 4, so it uses PlayStation button names
 */
typedef struct {
	...
	WORD btnShare:1, btnOptions:1, btnPS:1, btnReserved:3;
} RINPUT_STATE;
...
bool RawInputGetState(RINPUT_STATE *state);
